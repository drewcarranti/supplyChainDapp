...
contract SupplyChain{
    ...
    mapping(uint32 => product) public products;     // product by product id
    ...
    mapping(uint32 => participant) public participants;  // participants by participant id
    ...
    mapping(uint32 => ownership) public ownerships;    // ownerhsip by ownership id
    mapping(uint32 => uint32[]) public productTrack;  // ownership by product id
    ...
    function addProduct(uint32 _ownerId, string memory _modelNumber, string memory _partNumber, string memory serialNumber, uint32 _productCost) public returns (uint32){
     ...
     function getProduct(uint32 _productId) public view returns (string memory, string memory, string memory, uint32, address, uint32){
            return (products[_productId].modelNumber,
                ...
                products[_productId].mfgTimeStamp);
                                                ...
                                                //onlyOwner call relays to modifier above to restrict functionality
